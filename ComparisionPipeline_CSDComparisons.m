...
wpms.dirs  = struct('CWD','F:\FNL_EEG_TOOLBOX\',...
                    'packages','PACKAGES',...
...
wpms.conditions = {'mixrepeat','switchto'};%conditions of interest = repeat and switch
...
%MapMontage(M)
filename = [wpms.dirs.CWD wpms.dirs.REPAIRED_DATA wpms.names{name_i} '_RepairedData_' wpms.conditions{cond_i} '.mat'];
A = load(filename);
