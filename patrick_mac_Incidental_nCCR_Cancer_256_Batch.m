...
clear all
%warning off;
wpms.dirs  = struct('CWD','/Users/patrick/Desktop/nCCR_Cancer_EEG/','packages','PACKAGES', ...
...
wpms.names = {
    ...
    'n008_pre_mem_002'; ...
    'n010_pre_mem_002';'n011_pre_mem_002'; ...
    ...
    'n008_post_mem_002'; ...
     'n011_post_mem_002'; ...  % not trial 'n010_post_mem_002'; ...
...
%     'n005_pre_stroop_002';'n006_pre_stroop_002';% no trial :'n007_pre_stroop_002'; ...
%     'n008_pre_stroop_002'; ...
%     'n010_pre_stroop_002';'n011_pre_stroop_002'; ...
%     'n012_pre_stroop_002';'n013_pre_stroop_002'; ...
%     'n015_pre_stroop_002';'n016_pre_stroop_002'; ...
%     'n001_post_stroop_002';'n002_post_stroop_002';% no trial 'n003_post_stroop_002'; ...
%    'n006_post_stroop_002';'n007_post_stroop_002'; ... % inconsistent trial info 'n005_post_stroop_002';
%     'n008_post_stroop_002'; ...
%      'n011_post_stroop_002'; ...  % not trial 'n010_post_stroop_002';
...
%unusable eeg due to artifact : n003/n007 pre gonogo -  dropped
%n003/007post_gonogo match
...
%     condition = '_stroop'
    ...
    patrick_ccm_artifact_rejection_auto(wpms,name_i,1,30,-100,100,condition)
end
