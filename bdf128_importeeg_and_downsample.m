...
function [dat_final] = bdf128_importeeg_and_downsample(wpms,filext,name_i,fsample)
% check function inputs
    ...
    dat_final.trial{1,1} = zeros(header.nChans,ceil(header.nSamples/8));
    dat_final.time{1,1} = zeros(1,ceil(header.nSamples/8));
