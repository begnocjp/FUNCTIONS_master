...
wpms.names = {'1101_mem_002','1102_mem_002','1103_mem_002','1104_mem_002','1105_mem_002','1106_mem_002'};
...
for name_i = 4%:length(wpms.names)   
...
type = 'egi';
for name_i = 1%:length(wpms.names)
    ccm256_csd_transformation_v2(wpms,name_i); %,type);
end
