...
cfg.trl                           = eogcorr.cfg.previous.previous{1,1}.previous.trl; %possible mistake here, changing from  orig - patrick b. eogcorr.cfg.previous.previous{1,1}.previous.trl;
cfg.bpfilter                      = 'no';
