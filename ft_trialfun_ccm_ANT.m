function [trl] = ft_trialfun_ccm_ANT(cfg,name_i)
index = name_i;
%edited by Aaron/Alex/Patrick - 2017.01.09

% For ANT task we have a number of trigger codes, all in strings
% 5 cues = UP, DOWN, CENTER, DOUBLE, NO-CUE. Cue denoted by W
% 2 target locations = UP, DOWN; 2 target directions = LEFT, RIGHT. 
% Target Denoted by T
% 3 target types = CONGRUENT, INCONGRUENT, NEUTRAL
% 
% 'SESS' = not needed
% 'CELL' = not needed
...
% look for the combination of a each cue followed by a target
