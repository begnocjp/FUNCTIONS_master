function fnl_wavelet_analysis_v2(wpms,times,windowsize,bins,freqrange,channels,conditions,name_i)
...
%since we reduced freq range should reduce bins?
...
for cond_i = 1:length(current_file_types)
    for channi = CHANNELS
        ...
        %filename = [wpms.dirs.CWD wpms.dirs.preproc filesep wpms.names{name_i} '_CSDDATA_EEGLAB.mat'];
