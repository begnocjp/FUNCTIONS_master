%% MFF_EGI_IMPORTEEG_and_downsample
%
...
function [dat_final] = mff_importeeg_and_downsample(wpms,filext,name_i,fsample)
% check function inputs
    narginchk(4,4)
    fprintf('----- Importing EEG for : %s ------\n', ...
            wpms.names{name_i});
    filex = '.mff';
    header = ft_read_header([wpms.dirs.CWD wpms.dirs.RAW wpms.names{name_i} '.' filext],'headerformat','egi_mff_v1');
