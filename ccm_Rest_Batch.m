...
wpms.names = {'CAE901_fast_rest_t2_','CAE901_food_rest_t1_','CAE901_food_rest_t2_','JAB902_fast_rest_t1_','JAB902_fast_rest_t2_',...
    'JAB902_food_rest_t1_','JAB902_food_rest_t2_','CJD903_fast_rest_t1_','CJD903_fast_rest_t2_','CJD903_food_rest_t1_',...
'CJD903_food_rest_t2_','R-P904_fast_rest_t1_','R-P904_fast_rest_t2_','R-P904_food_rest_t1_','R-P904_food_rest_t2_',...
'SKY906_fast_rest_t1_','SKY906_food_rest_t1_','SKY906_food_rest_t2_',...
'AWH907_fast_rest_t1_','AWH907_fast_rest_t2_','AWH907_food_rest_t1_','AWH907_food_rest_t2_',...
'RKW908_fast_rest_t1_','RKW908_fast_rest_t2_','RKW908_food_rest_t1_','RKW908_food_rest_t2_',...
'D-D909_fast_rest_t1_','D-D909_fast_rest_t2_','D-D909_food_rest_t1_','D-D909_food_rest_t2_',...
'ASL910_fast_rest_t1_','ASL910_fast_rest_t2_','ASL_910_food_rest_t1_','ASL910_food_rest_t2_',...
'DJA912_fast_rest_t1_','DJA912_fast_rest_t2_','DJA912_food_rest_t1_','DJA912_food_rest_t2_'};

% Files Too Noisy to use: 'DMM905_fast_rest_t1_','DMM905_fast_rest_t2_','DMM905_food_rest_t1_','DMM905_food_rest_t2_','SKY906_fast_rest_t2_'
...
for name_i = 16%:length(wpms.names)
    ccm_artifact_rejection_auto(wpms,name_i,true,50,-100,100)
end
