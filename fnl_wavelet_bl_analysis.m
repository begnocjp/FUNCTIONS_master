function fnl_wavelet_analysis(wpms,times,windowsize,bins,freqrange,channels,conditions,name_i)
...
%                 [~,times2testidx{i}]=min(abs(EEG.times*1000-times2test{i}));
            ...
            for fi=1:length(frex)
                ...
                mw_tf(fi,:) = 10*log10(squeeze(mean(mean(freqdata(1,StartBaselineIdx:EndBaselineIdx,:),3),2)));
