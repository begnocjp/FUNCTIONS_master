...
l = find(mean(load_subs{1,name_i}.timelock(1).avg(front_chan,N2_lat)) == min(mean(load_subs{1,name_i}.timelock(1).avg(cent_chan,N2_lat))))
ERP.N2.Alerting_nocue_central_latpeak(name_i,1) =    (((N2_lat(1) + l) - 125) * 4)
l = find(mean(load_subs{1,name_i}.timelock(1).avg(front_chan,N2_lat)) == min(mean(load_subs{1,name_i}.timelock(1).avg(pari_chan,N2_lat))))
...
l = find(mean(load_subs{1,name_i}.timelock(2).avg(front_chan,N2_lat)) == min(mean(load_subs{1,name_i}.timelock(2).avg(cent_chan,N2_lat))))
ERP.N2.Alerting_double_central_latpeak(name_i,1) =    (((N2_lat(1) + l) - 125) * 4)
l = find(mean(load_subs{1,name_i}.timelock(2).avg(front_chan,N2_lat)) == min(mean(load_subs{1,name_i}.timelock(2).avg(pari_chan,N2_lat))))
...
l = find(mean(load_subs{1,name_i}.timelock(1).avg(front_chan,P3_lat)) == min(mean(load_subs{1,name_i}.timelock(1).avg(cent_chan,P3_lat))))
ERP.P3.Alerting_nocue_central_latpeak(name_i,1) =    (((P3_lat(1) + l) - 125) * 4)
l = find(mean(load_subs{1,name_i}.timelock(1).avg(front_chan,P3_lat)) == min(mean(load_subs{1,name_i}.timelock(1).avg(pari_chan,P3_lat))))
...
l = find(mean(load_subs{1,name_i}.timelock(2).avg(front_chan,P3_lat)) == min(mean(load_subs{1,name_i}.timelock(2).avg(cent_chan,P3_lat))))
ERP.P3.Alerting_double_central_latpeak(name_i,1) =    (((P3_lat(1) + l) - 125) * 4)
l = find(mean(load_subs{1,name_i}.timelock(2).avg(front_chan,P3_lat)) == min(mean(load_subs{1,name_i}.timelock(2).avg(pari_chan,P3_lat))))
...
l = find(mean(load_subs{1,name_i}.timelock(1).avg(front_chan,P1_lat)) == min(mean(load_subs{1,name_i}.timelock(1).avg(cent_chan,P1_lat))))
ERP.P1.Alerting_nocue_central_latpeak(name_i,1) =    (((P1_lat(1) + l) - 125) * 4)
l = find(mean(load_subs{1,name_i}.timelock(1).avg(front_chan,P1_lat)) == min(mean(load_subs{1,name_i}.timelock(1).avg(pari_chan,P1_lat))))
...
l = find(mean(load_subs{1,name_i}.timelock(2).avg(front_chan,P1_lat)) == min(mean(load_subs{1,name_i}.timelock(2).avg(cent_chan,P1_lat))))
ERP.P1.Alerting_double_central_latpeak(name_i,1) =    (((P1_lat(1) + l) - 125) * 4)
l = find(mean(load_subs{1,name_i}.timelock(2).avg(front_chan,P1_lat)) == min(mean(load_subs{1,name_i}.timelock(2).avg(pari_chan,P1_lat))))
