...
%  Patrick Begnoche in the house! April 2020
%% Set-up working parameters
close all
clear all
warning off;
wpms       = [];%working parameters
wpms.dirs  = struct('CWD','/gpfs23/scratch/begnocjp/Depressed_Mind/EEG_Substudy_Data/','packages','PACKAGES', ...
...
wpms.names = {'7187_CGNG002'}
%,'7108 Aud002','7151 Aud002','7166 AUD002','7170 Aud002','7175 Aud002','7191 Aud002','7195 Aud002',...
%    '7102_2Aud002','7108 2Aud002','7151 2Aud002','7166 2_AUD002','7170 2Aud002','7175 2Aud002','7191 2AUD002','7195_2 AUD002'};

% wpms.names = {'7187_Aud002','7102 Aud002','7108 Aud002','7151 Aud002','7166 AUD002','7170 Aud002','7175 Aud002','7191 Aud002','7195 Aud002',...
%     '7187 2 Aud002','7102_2Aud002','7108 2Aud002','7151 2Aud002','7166 2_AUD002','7170 2Aud002','7175 2Aud002','7191 2AUD002','7195_2 AUD002'};
%     
% wpms.names = {'7191 Aud002','7191 2Aud002'};


% add path
cd([wpms.dirs.CWD]);
addpath(genpath([wpms.dirs.CWD,wpms.dirs.FUNCTIONS]));
%addpath(genpath(['/gpfs52/home/begnocjp/Downloads/fieldtrip-20200320']));
addpath(['/gpfs52/home/begnocjp/Downloads/fieldtrip-20200320'])); 
%dont use gen path for fieldtrip
%% Preprocessing I
...
for name_i = 59%:length(wpms.names)   
