...
% 
%  USEAGE:
%         ccm_artifact_rejection_auto(wpms,name_i)
%  INPUTS:
...
function ccm_csd_transformation(wpms,name_i,type)
...
elseif strcmp(type, 'egi')
    [M] = ccm_genMontage_egi(wpms.dirs.CWD,wpms.dirs.preproc,wpms.names,name_i);
else
